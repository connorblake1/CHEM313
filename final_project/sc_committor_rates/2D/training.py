...
#     predictions = torch.sigmoid(net(data)[...,0])
...
#     a_predictions = torch.sigmoid(net(data)[...,0])
#     b_predictions = torch.sigmoid(-net(data)[...,0])
...
#     a_estimates = net(reporters)[...,0] + lengths
...
#     #else:
#     return loss(torch.sigmoid(net(data)[...,0]), a_targets)
...
#     a_prediction = torch.sigmoid(net(data)[...,0])
#     b_prediction = torch.sigmoid(-net(data)[...,0])
